  ...
  return (
    ...
    >
      <div className="background-wrapper">
        <img className="empty-state-background" src={require('../assets/mesh-background.png')} />
      </div>
      <div className="empty-state">
        ...
        <button className="button button--primary button--full" onClick={onRunApp}>
          Run Design Lint
        </button>
        <button className="button button--primary button-scan-page" onClick={onScanEntirePage}>
          Scan Entire Page
        </button>
      </div>
    </motion.div>
