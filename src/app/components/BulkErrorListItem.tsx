  ...
  return (
    ...
    >
      <div className="flex-row" ref={ref} onClick={showMenu}>
        ...
        <span className="error-description">
          {error.nodes.length > 1 ? (
            <div className="error-description__message">
              {error.message} <span className="error-description__count">· ({error.count})</span>
            </div>
          ) : (
        ...
        <motion.span whileTap={{ scale: 0.98, opacity: 0.8 }} className="context-icon">
      ...
      {error.matches && (
        <div className="auto-fix-content">
          <div className="auto-fix-style">
            <StyleContent style={error.matches[0]} type={error.type.toLowerCase()} error={error} />
          </div>
      ...
      {error.suggestions && (
        <>
          ...
          <div className="auto-fix-suggestion">
            ...
            <SuggestionButton error={error} index={0} applyStyle={handleSuggestion} />
          </div>
          {error.suggestions[1] && (
            <div className="auto-fix-suggestion suggestion-last">
              ...
              <SuggestionButton error={error} index={1} applyStyle={handleSuggestion} />
            </div>
          )}
        </>
      )}
