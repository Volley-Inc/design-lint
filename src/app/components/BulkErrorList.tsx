...
function BulkErrorList(props: BulkErrorListProps) {
  ...
  const [panelStyleSuggestion, setPanelStyleSuggestion] = useState<StyleMatch | null>(null);
  ...
  return (
    ...
    >
      ...
      <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} error={currentError} />
      <StylesPanel
